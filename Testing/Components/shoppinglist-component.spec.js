describe('shoppingList component', function() {
  ...
  it('should detect no cookies in its list', function() {
    ...
    // now create controller for component
    var ctrl = $componentController('shoppingList', {$element: null}, bindings);
    // inject somethingcalled $element since this is injected to the component but use null since it is not used in this test
